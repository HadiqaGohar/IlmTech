...
import { Clock, ArrowRight, Eye, Star } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5">
        {latestArticles.map((article) => (
          <Link
            ...
            className="group flex flex-col rounded-xl sm:rounded-2xl border border-gray-200 bg-white dark:bg-gray-800 dark:border-gray-700 overflow-hidden hover:shadow-xl hover:border-purple-200 dark:hover:border-purple-800 hover:scale-[1.02] transition-all duration-300 h-full"
          >
            {/* Image */}
            <div className="relative aspect-[16/9] bg-gradient-to-br from-[#37215F] to-[#0881BE] overflow-hidden">
              ...
              <div className="absolute top-3 left-3 z-10 flex items-center gap-2">
                ...
                {article.isFeatured && (
                  <span className="inline-flex items-center gap-1 rounded-full bg-yellow-500 px-2.5 py-0.5 text-[10px] sm:text-xs font-bold text-white shadow-md">
            ...
            <div className="p-4 sm:p-5 flex flex-col flex-1">
              ...
              <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 line-clamp-2 mb-3 sm:mb-4 leading-relaxed flex-1">
